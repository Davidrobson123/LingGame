...
var borderOffset = new Phaser.Point(550,200);//to centralise the isometric level display
var wallGraphicHeight=128;
var floorGraphicWidth=103;
var floorGraphicHeight=30;
var heroGraphicWidth=41;
var heroGraphicHeight=52;
...
function drawTileIso(tileType,i,j){//place isometric level tiles
    ...
    if(tileType !== 0){
        gameScene.renderXY(game.make.sprite(0, 0, 'floor', 'sprite' + tileType), isoPt.x+borderOffset.x+15, isoPt.y+borderOffset.y-wallHeight, false);
    }
